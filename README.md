...
2. Clone the repo
   ```sh
   git clone https://github.com/izafossato/lista-de-presenca-springboot.git
   ```
...
See the [open issues](https://github.com/izafossato/lista-de-presenca-springboot/issues) for a full list of proposed features (and known issues).
